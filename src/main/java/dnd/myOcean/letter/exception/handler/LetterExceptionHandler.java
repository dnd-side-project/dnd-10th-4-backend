...
public class LetterExceptionHandler {
    ...
    public ResponseEntity accessDeniedLetterException() {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity alreadyReplyExistException() {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity repliedLetterPassException() {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity unAnsweredLetterStoreException() {
