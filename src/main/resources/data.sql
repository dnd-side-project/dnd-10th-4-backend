...
INSERT INTO LETTER(sender_id, receiver_id, content, is_read, has_replied, create_date, worry_type)
VALUES (2, 1, '안녕', 0, 0, now(), 'WORK'),
       (3, 1, '안녕', 0, 0, now(), 'LOVE'),
       (4, 1, '안녕', 0, 0, now(), 'ETC'),
       (5, 1, '안녕', 0, 0, now(), 'BREAK_LOVE'),
       (6, 1, '안녕', 0, 0, now(), 'FAMILY'),
       (1, 2, '안녕', 0, 0, now(), 'LOVE'),
       (1, 3, '안녕', 0, 0, now(), 'WORK'),
       (1, 4, '안녕', 1, 0, now(), 'FAMILY'),
       (1, 5, '안녕', 1, 0, now(), 'ETC');
