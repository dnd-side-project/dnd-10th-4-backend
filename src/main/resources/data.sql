...
INSERT INTO member(create_Date, update_age_count, update_gender_count, email, nick_name, gender, role, age, has_report)
VALUES (now(), 0, 0, 'kdo0422@nate.com', '낯선 유저1', 'MALE', 'USER', 26, false),
       (now(), 0, 0, 'dog@naver.com', '낯선 강아지', 'MALE', 'USER', 20, false),
       (now(), 0, 0, 'cat@naver.com', '낯선 고양이', 'MALE', 'USER', 20, false),
       (now(), 0, 0, 'pig@naver.com', '낯선 돼지', 'MALE', 'USER', 100, false),
       (now(), 0, 0, 'cow@naver.com', '낯선 소', 'MALE', 'USER', 30, false),
       (now(), 0, 0, 'chicken@naver.com', '낯선 닭', 'MALE', 'USER', 40, false),
       (now(), 0, 0, 'tnlswodnjs99@naver.com', '낯선 사람', 'MALE', 'USER', 40, false);
...
VALUES ('1', 2, 1, '안녕', now(), 'WORK', true, false, true, '안녕하세요!'),
       ...
       ('2', 4, 7, '안녕', now(), 'FAMILY', false, false, false, ''),
